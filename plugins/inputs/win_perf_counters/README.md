...
.
Partial wildcards (e.g. `chrome*`) are supported only with instance names on Windows Vista and newer.
...
This must be specified for every counter you want the results of, or use `["*"]` for all the counters of the object,
